...
class HiddenServiceServer(
  ...
  override fun serve(session: IHTTPSession): Response {
    ...
    val responseHeaders = mapOf(
      Pair("Access-Control-Allow-Origin", origin),
      Pair("Access-Control-Allow-Methods", ALLOWED_METHODS),
      Pair("Access-Control-Allow-Headers", "Content-Type"),
  ...
  private fun handleRoot(headers: Map<String, String>): Response {
    val response = mapOf(
      Pair("service", "Dark Messenger Hidden Service"),
      Pair("version", "1.0.0"),
      Pair("status", "online"),
      Pair("timestamp", Date().toString())
    )
    return newFixedLengthResponse(
      Response.Status.OK,
      "application/json",
  ...
  private fun handleWcdyu(headers: Map<String, String>): Response {
    ...
    return try {
      val settings = if (settingsJson != null) {
        ...
        mapOf(
          Pair("darkmessenger", mapOf(
            Pair("cryptography", mapOf(
              Pair("useERK", mapOf(Pair("value", false), Pair("default", false), Pair("type", "toggle"))),
              Pair("offlineMessages", mapOf(
                Pair("ecies", mapOf(Pair("value", true), Pair("default", true), Pair("type", "toggle"))),
                Pair("rsa", mapOf(Pair("value", true), Pair("default", true), Pair("type", "toggle"))),
                Pair("crystalKyber", mapOf(Pair("value", true), Pair("default", true), Pair("type", "toggle")))
              )),
              Pair("onlineMessages", mapOf(
                Pair("ecies", mapOf(Pair("value", true), Pair("default", true), Pair("type", "toggle"))),
                Pair("rsa", mapOf(Pair("value", true), Pair("default", true), Pair("type", "toggle"))),
                Pair("crystalKyber", mapOf(Pair("value", true), Pair("default", true), Pair("type", "toggle")))
              )),
      ...
      val response = mapOf(
        Pair("use_erk", ((cryptography?.get("useERK") as? Map<*, *>)?.get("value") ?: false)),
        Pair("offline_messages", mapOf(
          Pair("ecies", ((cryptography?.get("offlineMessages") as? Map<*, *>)?.get("ecies") as? Map<*, *>)?.get("value") ?: true),
          Pair("rsa", ((cryptography?.get("offlineMessages") as? Map<*, *>)?.get("rsa") as? Map<*, *>)?.get("value") ?: true),
          Pair("crystal_kyber", ((cryptography?.get("offlineMessages") as? Map<*, *>)?.get("crystalKyber") as? Map<*, *>)?.get("value") ?: true)
        )),
        Pair("online_messages", mapOf(
          Pair("ecies", ((cryptography?.get("onlineMessages") as? Map<*, *>)?.get("ecies") as? Map<*, *>)?.get("value") ?: true),
          Pair("rsa", ((cryptography?.get("onlineMessages") as? Map<*, *>)?.get("rsa") as? Map<*, *>)?.get("value") ?: true),
          Pair("crystal_kyber", ((cryptography?.get("onlineMessages") as? Map<*, *>)?.get("crystalKyber") as? Map<*, *>)?.get("value") ?: true)
        )),
        Pair("add_me", mapOf(
          Pair("ecies", ((cryptography?.get("addMe") as? Map<*, *>)?.get("ecies") as? Map<*, *>)?.get("value") ?: true),
          Pair("rsa", ((cryptography?.get("addMe") as? Map<*, *>)?.get("rsa") as? Map<*, *>)?.get("value") ?: true),
          Pair("crystal_kyber", ((cryptography?.get("addMe") as? Map<*, *>)?.get("crystalKyber") as? Map<*, *>)?.get("value") ?: true)
        ))
      )
  ...
  private fun handleCrypto(headers: Map<String, String>): Response {
    return try {
      val response = mapOf(
        Pair("use_erk", false),
        Pair("message", "ERK not enabled in this client")
      )
      newFixedLengthResponse(
        Response.Status.OK,
        "application/json",
